...
This plugin contains plot and analysis functions.
...
```sh
git clone https://github.com/AG-SEK/solar-repo-perolab.git
cd solar-repo-perolab
...
```sh
pip install dist/solar-repo-perolab-0.1.0
```
